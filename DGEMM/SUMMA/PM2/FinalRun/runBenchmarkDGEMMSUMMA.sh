...
RESULTS_FILE="PM2DGEMMResultsSUMMA.csv"
RAW_LOG_DIR="dgemmRawLogsSUMMA"

DEFAULT_EXECUTABLE="./pm2dgemmSUMMA"
...
read -r -p "SUMMA executable [${DEFAULT_EXECUTABLE}]: " EXECUTABLE
...
runAlgorithm "SUMMA" "$EXECUTABLE" "summa"
